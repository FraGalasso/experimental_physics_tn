...
for i in range(1, 7):
    df_list.append(pd.read_csv(f'final_experiment/data/ACmeasurement_firstbatch/ac_first{i}.csv'))

for i in range(1, 7):
    df_list.append(pd.read_csv(f'final_experiment/data/ACmeasurement_secondbatch/ac_second{i}.csv'))
